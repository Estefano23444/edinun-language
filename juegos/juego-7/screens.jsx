// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para "Juego 7".
// Dos niveles temáticos del libro EDINUN:
//   1. La reseña             (8 años)  — ficha del libro, partes de la reseña, ordena el cuento
//   2. Aprendiendo a escribir (10 años) — pronombres, verboides, verbos regulares/irregulares
...
function CosmosBg({ variant = "cosmic", glyphSize }) {
  ...
  // Cosmic (home / character / results) — glifos de lectura y escritura
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "46%", top: "4%",  "--rot": "-4deg", fontSize: "0.42em" }}>yo</span>
        <span style={{ left: "7%",  top: "46%", "--rot": "-4deg", fontSize: "0.42em" }}>tú</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg",  fontSize: "0.42em" }}>él</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.42em" }}>ar</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.42em" }}>er</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg",  fontSize: "0.42em" }}>ir</span>
        ...
        <span style={{ left: "50%", top: "88%", "--rot": "4deg",  fontSize: "0.42em" }}>-ando</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.42em" }}>-ado</span>
      </div>
    </>
  );
}
...
const LEVELS_CFG = [
  {
    ...
    ink: "#3a2608",
    description: "Lee y opina sobre libros.",
    catLabel: "La reseña",
  },
  {
    id: "escritor",
    label: "Aprendiendo a escribir",
    grad: "linear-gradient(180deg, #ffe97a, #d7b12a)",
    ink: "#3a2608",
    description: "Pronombres y verbos para escribir mejor.",
    catLabel: "Aprendiendo a escribir",
  },
];
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    const lvCfg = LEVELS_CFG.find((l) => l.id === (app.level || "resena")) || LEVELS_CFG[0];
    setApp((s) => ({
      ...s,
      character: sel,
