...
// "Telón y galaxia" (TEMAS del libro EDINUN de Lengua y Literatura).
// Juego de 2 niveles por edad (Home con selector, router por app.level):
//   • NIVEL 1 (11 años) — El entremés (Rolli).
//   • NIVEL 2 (13 años) — La ciencia ficción (Verne).
// Home con selector de tema (formato juego-14). HUD del juego con tabs.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — tema "teatro cómico + ciencia ficción":
// máscaras, telón, cohete, robot, galaxia, átomo, planeta.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "🎭",  l: "6%",  t: "12%", r: "-8deg", s: "0.5em" },
  { c: "🚀",  l: "82%", t: "16%", r: "6deg",  s: "0.55em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "🚀",  l: "84%", t: "6%",  r: "6deg",  s: "0.72em" },
  { c: "🌌",  l: "92%", t: "72%", r: "-12deg", s: "0.7em" },
  { c: "🛸",  l: "3%",  t: "82%", r: "12deg",  s: "0.66em" },
  { c: "🎬",  l: "46%", t: "4%",  r: "-4deg",  s: "0.56em" },
  { c: "⚛",   l: "7%",  t: "46%", r: "-4deg",  s: "0.66em" },
  { c: "→",   l: "88%", t: "40%", r: "8deg",   s: "0.6em" },
  { c: "🎪",  l: "22%", t: "22%", r: "10deg",  s: "0.56em" },
  { c: "👽",  l: "70%", t: "24%", r: "-6deg",  s: "0.55em" },
...
// Personaje temático: entremés → Rolli (escritor, la dramaturga);
// ciencia ficción → Verne (explorador, padre del género). El niño puede
// cambiarlo. La descripción cuenta DE QUÉ TRATA el tema, no la mecánica.
// ─────────────────────────────────────────────────────────────
const LEVELS_CFG = [
  {
    id: "entremes",
    ...
    ink: "#3a2608",
    description: "Teatro cómico y breve que nació para hacer reír al público.",
    catLabel: "El entremés · 11 años",
    char: "escritor",
  },
  {
    id: "cienciaficcion",
    age: "13 años",
    label: "La ciencia ficción",
    grad: "linear-gradient(180deg, #ffc06e, #e4881a)",
    ink: "#3a2608",
    description: "Mundos posibles donde la ciencia imagina cómo será el futuro.",
    catLabel: "La ciencia ficción · 13 años",
    char: "explorador",
  },
];
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 520 }}>
          ...
          {/* Selector de tema — botones grandes con degradado (formato
              juego-1, 2 botones) + cajita de descripción debajo. */}
          <div>
