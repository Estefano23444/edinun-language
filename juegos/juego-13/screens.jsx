// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-13
// "De oruga a mariposa" (TEMA 3 del libro EDINUN, 8 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS (laboratorio · cámara ·
// clasificar). Tema: SUFIJOS y PREFIJOS — formar adjetivos (-ado, -oso, -al,
// -áceo, -uzco, -ar) y verbos (-ificar, -ear, -ecer, -izar) + prefijos a-/en-.
// Envoltorio: un reportaje sobre la metamorfosis de la mariposa.
// Home sin chips de dificultad.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — los sufijos y prefijos del tema, como texto,
// para ambientar sin distraer.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "ado", l: "5%",  t: "12%", r: "-8deg" },
  { c: "oso", l: "80%", t: "16%", r: "6deg",  s: "0.62em" },
  { c: "al",  l: "10%", t: "78%", r: "12deg", s: "0.7em" },
  { c: "ar",  l: "86%", t: "72%", r: "-10deg", s: "0.6em" },
  { c: "ecer",l: "44%", t: "8%",  r: "4deg",  s: "0.5em" },
  { c: "izar",l: "3%",  t: "45%", r: "-4deg", s: "0.55em" },
  { c: "a",   l: "92%", t: "44%", r: "8deg",  s: "0.62em" },
  { c: "en",  l: "30%", t: "56%", r: "-6deg", s: "0.55em" },
  { c: "ear", l: "70%", t: "62%", r: "8deg",  s: "0.52em" },
  { c: "uzco",l: "55%", t: "30%", r: "-4deg", s: "0.46em" },
];

const COSMIC_GLYPHS = [
  { c: "ado", l: "5%",  t: "10%", r: "-8deg" },
  { c: "oso", l: "84%", t: "6%",  r: "6deg",  s: "0.78em" },
  { c: "al",  l: "92%", t: "72%", r: "-12deg", s: "0.74em" },
  { c: "ar",  l: "3%",  t: "82%", r: "12deg",  s: "0.85em" },
  { c: "áceo",l: "46%", t: "4%",  r: "-4deg",  s: "0.59em" },
  { c: "uzco",l: "7%",  t: "46%", r: "-4deg",  s: "0.6em" },
  { c: "ecer",l: "88%", t: "40%", r: "8deg",   s: "0.6em" },
  { c: "izar",l: "22%", t: "22%", r: "10deg",  s: "0.55em" },
  { c: "ear", l: "70%", t: "24%", r: "-6deg",  s: "0.57em" },
  { c: "ificar",l: "30%", t: "70%", r: "8deg", s: "0.52em" },
  { c: "a",   l: "62%", t: "78%", r: "-10deg", s: "0.7em" },
  { c: "en",  l: "16%", t: "58%", r: "14deg",  s: "0.7em" },
  { c: "🦋",   l: "78%", t: "56%", r: "-8deg",  s: "0.9em" },
  { c: "🐛",   l: "50%", t: "88%", r: "4deg",   s: "0.8em" },
  { c: "🍃",   l: "40%", t: "38%", r: "-6deg",  s: "0.8em" },
];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Forma palabras nuevas con sufijos y prefijos
            <br />
            <span style={{ color: "#ffd76e", fontSize: 16, letterSpacing: "0.04em" }}>
              ado · oso · al · ecer · izar · a · en
            </span>
          </div>
...
// ─────────────────────────────────────────────────────────────
// 2. SELECCIÓN DE PERSONAJE — idéntico al shell. Default Verne
// (explorador) porque encaja temáticamente con el reportero que
// investiga la metamorfosis de la mariposa.
// ─────────────────────────────────────────────────────────────
function CharacterScreen({ app, setApp, go }) {
  const [sel, setSel] = useState(app.character || "explorador");
