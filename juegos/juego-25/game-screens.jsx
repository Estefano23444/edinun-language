...
function makeProblemR1() {
  ...
  ]); // mazo de 8 cartas balanceado: 4 estereotipo + 4 inclusivo
  return { deck };
}
...
function RescateLengua({ cards, onFinish }) {
  ...
  function tap(c) {
    ...
    if (c.good) {
      ...
      // Tocar una acción que debilita la lengua BAJA la barra de vitalidad
      // (la metáfora del juego: la lengua se debilita). Acotado a 0.
      setVit((v) => Math.max(0, v - Math.ceil(100 / goodTotal)));
    }
  }
