...
const R3_COLORES = [
  { id: "kael1", planeta: "KAEL", emoji: "🪐",
    ...
    explica: "En Kael no existe la palabra «azul»: solo «claro» y «oscuro». Por eso su lengua ve el cielo como «claro»." },
  { id: "kael2", planeta: "KAEL", emoji: "🪐",
    ...
    explica: "En Kael no hay «blanco» ni «brillante»: la nieve solo puede ser «clara». Su lengua distingue únicamente claro y oscuro." },
  { id: "vure1", planeta: "VURË", emoji: "🌑",
    ...
    explica: "En Vurë no existen «azul» ni «verde»: el mar solo puede ser «oscuro» o «claro»." },
  { id: "vure2", planeta: "VURË", emoji: "🌑",
    ...
    explica: "En Vurë no hay «roja» ni «amarilla»: la flor solo puede ser «clara» u «oscura»." },
  { id: "kael3", planeta: "KAEL", emoji: "🪐",
    ...
    explica: "En Kael no hay «negra» ni «morada»: la noche solo puede ser «oscura» o «clara»." },
  { id: "kael4", planeta: "KAEL", emoji: "🪐",
    ...
    explica: "En Kael no existen «gris» ni «violeta»: el cielo solo puede ser «oscuro» o «claro»." },
  { id: "vure3", planeta: "VURË", emoji: "🌑",
    ...
    explica: "En Vurë no hay «sucia» ni «azulada»: la nieve solo puede ser «oscura» o «clara»." },
];
const R3_TIEMPO = [
...
const R3_NUMEROS = [
  { id: "nove1", planeta: "NOVE", emoji: "🛰️",
    ...
    explica: "Cuatro veintes (4×20 = 80) más doce = 92. En Nove los números se arman así." },
  { id: "nove2", planeta: "NOVE", emoji: "🛰️",
    ...
    explica: "Tres veintes (3×20 = 60) más cinco = 65. Nove arma los números por veintenas." },
  { id: "trell1", planeta: "TRELL", emoji: "☄️",
    ...
    explica: "Dos veintes (2×20 = 40) más siete = 47. En Trell los números se arman así." },
  { id: "trell2", planeta: "TRELL", emoji: "☄️",
    ...
    explica: "Tres veintes (3×20 = 60) más diez = 70. En Trell los números se arman así." },
  { id: "nove3", planeta: "NOVE", emoji: "🛰️",
    ...
    explica: "Dos veintes (2×20 = 40) más tres = 43. En Nove los números se arman así." },
  { id: "nove4", planeta: "NOVE", emoji: "🛰️",
    ...
    explica: "Cuatro veintes (4×20 = 80) más uno = 81. En Nove los números se arman así." },
  { id: "trell3", planeta: "TRELL", emoji: "☄️",
    ...
    explica: "Un veinte (1×20 = 20) más ocho = 28. En Trell los números se arman así." },
];
...
function makeProblemR1() {
  ...
  ]).slice(0, 3); // solo 3 cartas (mezcla variable de estereotipos e inclusivos)
  return { deck };
}
...
function DescifraMundo({ retos, onFinish }) {
  ...
  function choose(opt) {
    ...
    // Más tiempo al fallar para leer con calma la explicación (enseña el concepto).
    const wait = opt.ok ? 2100 : 5200;
    timerRef.current = setTimeout(() => {
      const next = idx + 1;
      setResult(null);
      setPicked(null);
