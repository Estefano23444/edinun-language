// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-25
...
// ─────────────────────────────────────────────────────────────
// Glifos del fondo — símbolos de lengua, percepción y mundo (mundo,
// bocadillos, ojo, colores, letras, mente) para ambientar sin distraer.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
...
const LEVELS_CFG = [
  {
    id: "lengua",
    label: "Otras palabras, otros mundos",
    grad: "linear-gradient(180deg, #b794ff, #6a4bd0)",
    ink: "#1c1140",
    description: "Detecta estereotipos, ayuda a salvar una lengua y descubre cuánto influye el idioma en cómo vemos el mundo.",
    catLabel: "Otras palabras, otros mundos",
  },
];
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#b794ff", marginBottom: 6 }}>
              ¿Por qué el mundo se ve diferente según la lengua?
            </div>
...
// (escritor), guía de las palabras y de cómo la lengua moldea la
// forma de ver el mundo (TEMA 2, 14 años).
// ─────────────────────────────────────────────────────────────
