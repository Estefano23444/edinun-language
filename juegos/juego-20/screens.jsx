...
// "Cuéntalo al mundo" (TEMAS del libro EDINUN de Lengua y Literatura).
// Juego de 2 niveles por edad (Home con selector, router por app.level):
//   • NIVEL 1 (11 años) — El blog (Verne).
//   • NIVEL 2 (14 años) — La entrevista (Rolli).
// Home con selector de tema (formato juego-14). HUD del juego con tabs.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — tema "comunicación digital + periodismo":
// computadora, blog, web, micrófono, podcast, chat, noticia.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "💻",  l: "6%",  t: "12%", r: "-8deg", s: "0.5em" },
  { c: "🎙️",  l: "82%", t: "16%", r: "6deg",  s: "0.55em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "🎙️",  l: "84%", t: "6%",  r: "6deg",  s: "0.72em" },
  { c: "📰",  l: "92%", t: "72%", r: "-12deg", s: "0.66em" },
  { c: "💬",  l: "3%",  t: "82%", r: "12deg",  s: "0.62em" },
...
// Personaje temático: blog → Verne (explorador, ventana al mundo);
// entrevista → Rolli (escritora, el arte de preguntar). El niño puede
