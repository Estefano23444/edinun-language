...
// ─────────────────────────────────────────────────────────────
// Glifos del fondo — la letra y, la letra f y sus sílabas, con
// libros 📖 y una pluma ✎ que homenajean el tema "la biblioteca".
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "y",  l: "6%",  t: "12%", r: "-8deg" },
  { c: "f",  l: "82%", t: "16%", r: "6deg",  s: "0.62em" },
  { c: "ya", l: "10%", t: "78%", r: "12deg", s: "0.7em" },
  { c: "fo", l: "88%", t: "72%", r: "-10deg", s: "0.55em" },
  { c: "ye", l: "45%", t: "8%",  r: "4deg",  s: "0.5em" },
  { c: "fi", l: "3%",  t: "45%", r: "-4deg", s: "0.6em" },
...
const COSMIC_GLYPHS = [
  { c: "y",  l: "5%",  t: "10%", r: "-8deg" },
  { c: "f",  l: "84%", t: "6%",  r: "6deg",  s: "0.78em" },
  { c: "ya", l: "92%", t: "72%", r: "-12deg", s: "0.74em" },
  { c: "ye", l: "3%",  t: "82%", r: "12deg",  s: "0.91em" },
  { c: "yo", l: "46%", t: "4%",  r: "-4deg",  s: "0.59em" },
  { c: "yu", l: "7%",  t: "46%", r: "-4deg",  s: "0.67em" },
  { c: "fa", l: "88%", t: "40%", r: "8deg",   s: "0.65em" },
  { c: "fe", l: "22%", t: "22%", r: "10deg",  s: "0.52em" },
  { c: "fi", l: "70%", t: "24%", r: "-6deg",  s: "0.57em" },
  { c: "fo", l: "32%", t: "70%", r: "8deg",   s: "0.61em" },
  { c: "fu", l: "62%", t: "78%", r: "-10deg", s: "0.63em" },
...
const LEVELS_CFG = [
  {
    ...
    ink: "#3a2608",
    description: "Completa palabras con y · f.",
    catLabel: "Explorando la biblioteca",
    char: "explorador",
  },
  {
    id: "poemas",
    age: "10 años",
    label: "Poemas populares",
    grad: "linear-gradient(180deg, #ffe97a, #d7b12a)",
    ink: "#3a2608",
    description: "Rima, tipos de poema y detective de versos.",
    catLabel: "Poemas populares · 10 años",
    char: "poeta",
  },
  {
    id: "voces",
    age: "12 años",
    label: "El poema y sus voces",
    grad: "linear-gradient(180deg, #7ab8ff, #2773d8)",
    ink: "#08264d",
    description: "Figuras, clases de rima y laboratorio del verso.",
    catLabel: "El poema y sus voces · 12 años",
    char: "poeta",
  },
  {
    id: "opinion",
    age: "14 años",
    label: "El género de opinión",
    grad: "linear-gradient(180deg, #c39cff, #7a3ce0)",
    ink: "#1a0a3a",
    description: "Tipos de texto, hecho u opinión y oraciones sin verbo.",
    catLabel: "El género de opinión · 14 años",
    char: "escritor",
  },
];
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        {/* Derecha — saludo + selector de nivel + nombre + ENTRAR. */}
        <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 540 }}>
          ...
          {/* Selector de nivel por edad — formato juego-8: botones sólidos
              con degradado + cajita de descripción debajo. */}
          <div>
...
// ─────────────────────────────────────────────────────────────
// 2. SELECCIÓN DE PERSONAJE — idéntico al shell. Default Verne (el
// Explorador) porque encaja temáticamente con "explorar la biblioteca".
// ─────────────────────────────────────────────────────────────
