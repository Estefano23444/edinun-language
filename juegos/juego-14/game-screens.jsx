...
const WORD_BANK = [
  ...
  { word: "yeso",   syll: "ye", emoji: "🩹", set: "y" },
  { word: "yogur",  syll: "yo", emoji: "🍦", set: "y" },
  { word: "yunque", syll: "yu", emoji: "⚒️", set: "y" },
  { word: "yacare", syll: "ya", emoji: "🐊", set: "y" },
  ...
  { word: "falda",   syll: "fa", emoji: "👗", set: "f" },
  { word: "faro",    syll: "fa", emoji: "🗼", set: "f" },
  { word: "fila",    syll: "fi", emoji: "🚶", set: "f" },
  { word: "fino",    syll: "fi", emoji: "🧵", set: "f" },
  { word: "fecha",   syll: "fe", emoji: "📅", set: "f" },
];
const SYLL_SETS = {
  y: ["ya", "ye", "yi", "yo", "yu"],
  f: ["fa", "fe", "fi", "fo", "fu"],
