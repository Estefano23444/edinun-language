...
// "Explorando la biblioteca" (TEMA 1 del libro EDINUN). Juego de 2 niveles:
//   • NIVEL 1 (6 años) — BibliotecaGame: completar palabra con la sílaba
//     inicial (letra y / letra f). 3 rondas, misma mecánica.
//   • NIVEL 2 (10 años) — PoemasGame: "Poemas populares". 3 rondas DISTINTAS
//     (estándar 7+): R1 Ruleta (clasifica el tipo), R2 Completa la rima,
//     R3 Detective de versos (halla el verso que no rima).
//
...
function BibliotecaGame({ app, setApp, go, onRestart }) {
  ...
  function verify() {
    ...
    const isCorrect = picked === problem.syll;
    answer(isCorrect, picked, problem.syll, problem.emoji, problem.word);
  }
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div data-qa="zona-central" style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: SLOT_GAP, padding: "4px 6px" }}>
          <button onClick={() => { if (picked && !feedback) setPicked(null); }} style={{
            width: SLOT_W * 1.6, height: SLOT_H, borderRadius: 12,
            border: `2.5px solid ${feedback === "ok" ? "#2ecc8f" : feedback === "err" ? "#ff6b6b" : picked ? "#fce9a8" : "rgba(242,194,96,0.55)"}`,
      ...
      <div data-qa="bandeja" style={{
        ...
        {problem.traySylls.map((syll, trayIdx) => {
          ...
          const showCorrect = feedback === "err" && syll === problem.syll;
          const showWrong = feedback === "err" && isPicked && syll !== problem.syll;
          ...
          return (
            <button key={trayIdx} className="ed-numpad-key"
              onClick={() => { if (!feedback) setPicked(syll); }}
              style={{
                ...
                cursor: feedback ? "default" : "pointer", fontWeight: 800, letterSpacing: "0.04em",
      ...
      <ActionRail
        canVerify={!feedback} onVerify={verify}
        showErase onErase={() => { if (!feedback) setPicked(null); }}
...
function PoemasGame({ app, setApp, go, onRestart }) {
  ...
  const canVerify =
    feedback ? false :
    ronda === 0 ? (r1Spun && r1Choice !== null && !r1Locked) :
  ...
  function handleVerify() {
    ...
    if (ronda === 0) {
      setR1Locked(true);
      const correct = r1Choice === r1Pick.tipo;
      setTimeout(() => answer(correct, r1Choice, r1Pick.tipo, "🎡", "Tipo de poema"), correct ? 450 : 1500);
    } else if (ronda === 1) {
      setR2Locked(true);
      const correct = r2Choice === r2Pick.answer;
      setTimeout(() => answer(correct, r2Choice, r2Pick.answer, "✒️", "Completa la rima"), correct ? 450 : 1500);
    } else if (ronda === 2) {
      setR3Locked(true);
      const correct = r3Choice === r3Pick.intruder;
      setTimeout(() => answer(correct, r3Pick.lines[r3Choice], r3Pick.lines[r3Pick.intruder], "🔍", "Verso intruso"), correct ? 450 : 1500);
    }
  }
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
                {TIPOS.map((t) => (
                  <OptionButton key={t} label={t} locked={r1Locked}
                    ...
                    onClick={() => setR1Choice((c) => (c === t ? null : t))}
                    color="#a78bfa" />
                ))}
              </div>
            </>
          ...
          <div style={{ position: "relative", width: "fit-content", maxWidth: 460 }}>
            ...
            <div style={{
              ...
              {r3Pick.lines.map((line, i) => {
                ...
                return (
                  <button key={i} onClick={() => { if (!r3Locked) setR3Choice((c) => (c === i ? null : i)); }}
                    style={{
...
const R3_DISCURSOS = [
  { id: "lectura", partes: [
    ...
    { id: "lec3", n: 3, parte: "La refutación",   cue: "“Dirán que aburre; aún no hallan su libro.”" },
    { id: "lec4", n: 4, parte: "La confirmación", cue: "“Quien lee en mi aula escribe mejor.”" },
  ...
  { id: "deporte", partes: [
    ...
    { id: "dep3", n: 3, parte: "La refutación",   cue: "“Hay quien dice no tener tiempo.”" },
    { id: "dep4", n: 4, parte: "La confirmación", cue: "“Bastan quince minutos al día.”" },
  ...
  { id: "ambiente", partes: [
    ...
    { id: "amb3", n: 3, parte: "La refutación",   cue: "“Algunos creen que no sirve de nada.”" },
    { id: "amb4", n: 4, parte: "La confirmación", cue: "“Mi barrio ya recicla y se nota.”" },
  ...
  { id: "amistad", partes: [
    ...
    { id: "ami3", n: 3, parte: "La refutación",   cue: "“No todo es estar siempre de acuerdo.”" },
    { id: "ami4", n: 4, parte: "La confirmación", cue: "“Mi mejor amiga me escucha de verdad.”" },
...
const R3_ORA = {
  ...
  interjeccion: [
    ...
    { id: "i3", text: "¡Qué alegría!" }, { id: "i4", text: "¡Auxilio!" },
  ],
  nominal: [
