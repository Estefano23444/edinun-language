// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-23
// "Buscando la palabra adecuada" (TEMA 3 del libro EDINUN, 13 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS:
//   R1 — Sintoniza el mensaje: DIAL. Gira el dial para clasificar el
//        registro de un mensaje (coloquial · estándar · culto).
//   R2 — Chat correcto: SIMULADOR de chat. Respondes a distintos
//        receptores eligiendo el mensaje con el registro adecuado.
//   R3 — Reparador de mensajes: ARRASTRE. Cambias las palabras fuera de
//        registro por la forma adecuada.
// Tema: ADECUACIÓN — niveles del lenguaje, la situación comunicativa y el
// receptor. Personaje destacado por defecto: Márquez (narrador), guía para
// elegir las palabras adecuadas según con quién se habla. Home sin chips de
// dificultad.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — símbolos de comunicación, chat y registros
// (bocadillos, teléfono, escritura, micrófono) para ambientar el tema
// de la adecuación sin distraer.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "💬", l: "6%",  t: "12%", r: "-8deg", s: "0.5em" },
  { c: "📱", l: "82%", t: "16%", r: "6deg",  s: "0.5em" },
  { c: "✍️", l: "10%", t: "78%", r: "12deg", s: "0.5em" },
  { c: "🗣️", l: "88%", t: "72%", r: "-10deg", s: "0.52em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "📱", l: "84%", t: "6%",  r: "6deg",  s: "0.6em" },
  { c: "🗣️", l: "92%", t: "72%", r: "-12deg", s: "0.7em" },
  { c: "✍️", l: "3%",  t: "82%", r: "12deg",  s: "0.66em" },
  ...
  { c: "📝", l: "18%", t: "58%", r: "14deg",  s: "0.55em" },
  { c: "🗨️", l: "78%", t: "56%", r: "-8deg",  s: "0.52em" },
...
const LEVELS_CFG = [
  {
    id: "registro",
    label: "Buscando la palabra adecuada",
    grad: "linear-gradient(180deg, #5fe0d0, #2a8fb0)",
    ink: "#06303a",
    description: "Sintoniza el registro de cada mensaje, responde según con quién hablas y repara las palabras fuera de lugar.",
    catLabel: "Buscando la palabra adecuada",
  },
];
...
// (narrador) porque guía a elegir las palabras adecuadas según con
// quién se habla (tema de adecuación, 13 años).
// ─────────────────────────────────────────────────────────────
