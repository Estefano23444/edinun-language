// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para "Juego 3".
// Dos niveles: La letra C y Q · Elementos del texto. Cada uno mapea a una
...
function CosmosBg({ variant = "cosmic", glyphSize }) {
  ...
  if (variant === "chalkboard") {
    const glyphs = (typeof window !== "undefined" && window.__currentChalkGlyphs) || [
      ...
      { c: "ce", l: "10%", t: "78%", r: "12deg", s: "0.5em" },
      { c: "ci", l: "88%", t: "72%", r: "-10deg", s: "0.5em" },
      { c: "qu", l: "45%", t: "8%",  r: "4deg",  s: "0.55em" },
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "84%", top: "6%",  "--rot": "6deg",  fontSize: "0.78em" }}>Q</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.74em" }}>📖</span>
        <span style={{ left: "3%",  top: "82%", "--rot": "12deg", fontSize: "0.85em" }}>💬</span>
        <span style={{ left: "46%", top: "4%",  "--rot": "-4deg", fontSize: "0.55em" }}>ce</span>
        <span style={{ left: "7%",  top: "46%", "--rot": "-4deg", fontSize: "0.55em" }}>ci</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg",  fontSize: "0.65em" }}>📝</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.6em" }}>✏</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.5em" }}>qu</span>
...
const LEVELS_CFG = [
  {
    id: "letraCQ",
    label: "La letra C y Q",
    grad: "linear-gradient(180deg, #ffc06e, #e4881a)",
    ink: "#3a2608",
    description: "Completa palabras con CA, CE, CI, CO, CU, QUE, QUI.",
    catLabel: "La letra C y Q",
  },
  {
    id: "elementosTexto",
    label: "Elementos del texto",
    grad: "linear-gradient(180deg, #7ab8ff, #2773d8)",
    ink: "#08264d",
    description: "Descubre el sentido escondido en lo que lees.",
    catLabel: "Elementos del texto",
  },
];
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    const lvCfg = LEVELS_CFG.find((l) => l.id === (app.level || "letraCQ")) || LEVELS_CFG[0];
    setApp((s) => ({
      ...s,
      character: sel,
