// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-12
// "Te invito a mi fiesta" (TEMA 2 del libro EDINUN, 7 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS (shooter · lectura ·
// ruleta). Tema: ortografía de la fiesta — la m antes de p y b, palabras
// homófonas y lenguaje formal vs coloquial. Home sin chips de dificultad.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — la fiesta (🎉 🎈 🎂 🎁 📨) + la ortografía del
// tema (mp · mb · m · p · b) como texto, con signos para el ritmo.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "mp", l: "6%",  t: "12%", r: "-8deg" },
  { c: "mb", l: "82%", t: "16%", r: "6deg",  s: "0.62em" },
  { c: "m",  l: "10%", t: "78%", r: "12deg", s: "0.7em" },
  { c: "b",  l: "88%", t: "72%", r: "-10deg", s: "0.55em" },
  { c: "p",  l: "45%", t: "8%",  r: "4deg",  s: "0.5em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "🎁", l: "3%",  t: "82%", r: "12deg",  s: "0.91em" },
  { c: "📨", l: "46%", t: "4%",  r: "-4deg",  s: "0.59em" },
  { c: "mp", l: "7%",  t: "46%", r: "-4deg",  s: "0.67em" },
  { c: "mb", l: "88%", t: "40%", r: "8deg",   s: "0.65em" },
  { c: "m",  l: "22%", t: "22%", r: "10deg",  s: "0.52em" },
  { c: "p",  l: "70%", t: "24%", r: "-6deg",  s: "0.57em" },
  { c: "b",  l: "32%", t: "70%", r: "8deg",   s: "0.61em" },
...
const LEVELS_CFG = [
  {
    id: "fiesta",
    label: "Te invito a mi fiesta",
    grad: "linear-gradient(180deg, #ffe97a, #d7b12a)",
    ink: "#3a2608",
    description: "Prepara la invitación de la fiesta jugando con las palabras.",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            La m antes de la p y b · Palabras homófonas · Formal o coloquial
          </div>
...
// (narrador) porque es el anfitrión que organiza la fiesta y da
// continuidad con los últimos juegos de lenguaje.
// ─────────────────────────────────────────────────────────────
