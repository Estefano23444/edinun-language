...
const ERRORES_BANK = [
  {
    id: "uv",
    tokens: "En este estudio, se [investigo] el impacto de la luz UV en las plantas de tomate. La [ipotesis] era que la luz UV podría afectar negativamente su [crezimiento]. Por eso, las plantas fueron [obserbadas] durante todo el verano por estudiantes del colegio.",
    correctos: { investigo: "investigó", ipotesis: "hipótesis", crezimiento: "crecimiento", obserbadas: "observadas" },
  },
  {
    id: "plantas",
    tokens: "Las plantas se [espusieron] a cuatro niveles de luz: control, bajo, medio y alto. [avia] 20 plantas en total y fueron [monitorisadas] durante 30 días. Cada semana se [tomava] una fotografía para ver los cambios.",
    correctos: { espusieron: "expusieron", avia: "había", monitorisadas: "monitorizadas", tomava: "tomaba" },
  },
  {
    id: "noticia_lectura",
    tokens: "Los adolescentes leen cada vez menos libros. Una [encuezta] del Ministerio [rebeló] que el 40% de jóvenes no [a] tomado un libro fuera del colegio en el último año. El [problemma] preocupa a maestros y familias.",
    correctos: { encuezta: "encuesta", rebeló: "reveló", a: "ha", problemma: "problema" },
  },
  {
    id: "carta_amigo",
    tokens: "Querido Andrés: te [escrivo] desde Quito porque [estube] pensando en ti. [Ojala] vengas pronto a visitarme. Mi mamá [ase] arroz con pollo los domingos y siempre te [estraño].",
    correctos: { escrivo: "escribo", estube: "estuve", Ojala: "Ojalá", ase: "hace", estraño: "extraño" },
  },
  {
    id: "noticia_clima",
    tokens: "El [Insituto] Geofísico anunció [aller] que el volcán [esta] activo. Se pide a la población [aser] caso a las recomendaciones de seguridad y mantener la calma.",
    correctos: { Insituto: "Instituto", aller: "ayer", esta: "está", aser: "hacer" },
  },
  {
    id: "carta_profe",
    tokens: "Estimada profesora: le [escrivo] para [desirle] que mi hijo no [pudó] entregar la tarea porque [estubo] enfermo toda la semana. Adjunto el certificado médico.",
    correctos: { escrivo: "escribo", desirle: "decirle", "pudó": "pudo", estubo: "estuvo" },
  },
  {
    id: "noticia_bar",
    tokens: "El bar del colegio [cambio] sus productos este año. Ya no se [bende] comida chatarra y los estudiantes [an] notado la diferencia. Sin embargo, algunos [exijen] que vuelvan las gaseosas.",
    correctos: { cambio: "cambió", bende: "vende", an: "han", exijen: "exigen" },
  },
  {
    id: "diario",
    tokens: "Hoy fue un día raro. Me [levante] tarde, [perdi] el bus y [yegué] al colegio sin desayunar. Por suerte, mi amiga Lucía [conpartio] su sándwich [con migo].",
    correctos: { levante: "levanté", perdi: "perdí", yegué: "llegué", conpartio: "compartió", "con migo": "conmigo" },
  },
];
...
function TiposTriviaCard({ pick, selected, locked, onSelect }) {
  ...
  return (
    <div style={{
      ...
      {/* Opciones apiladas en columna debajo, mismo eje vertical */}
...
function OrdenInformeCard({ contexto, pieces, placed, picked, verified, onPickPiece, onPickFromSlot, onPlaceAt }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, padding: "4px 8px", display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", gap: 12, flex: 1, minHeight: 0, justifyContent: "center", alignItems: "flex-start" }}>
...
function ConectoresCard({ pick, opciones, selected, locked, onSelect }) {
  ...
  return (
    <div style={{
      display: "flex", flexDirection: "column", alignItems: "center",
      justifyContent: "flex-start", height: "100%", gap: 18, padding: "8px 8px 0",
    }}>
      <div style={{
...
function HomofonasCard({ pick, selected, locked, onSelect }) {
  ...
  return (
    <div style={{
      display: "flex", flexDirection: "column", alignItems: "center",
      justifyContent: "flex-start", height: "100%", gap: 22, padding: "8px 8px 0",
    }}>
      <div style={{
        background: "linear-gradient(180deg, rgba(195,156,255,0.95), rgba(167,139,250,0.95))",
        border: "1px solid rgba(255,255,255,0.55)",
