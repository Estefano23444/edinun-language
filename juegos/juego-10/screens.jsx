// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-10
// "Mi fabulosa fábula" (TEMA 3 del libro EDINUN, 7 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS:
//   R1 ordenar Inicio/Nudo/Desenlace · R2 elegir la moraleja ·
//   R3 acertijo: formar el nombre del personaje con sílabas.
// Home sin chips de dificultad. HUD del juego sin tabs de nivel.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — animales de fábula (zorro, tortuga, ratón,
// caballo) + símbolos de escritura, homenajeando "Mi fabulosa fábula".
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "📖", l: "6%",  t: "12%", r: "-8deg", s: "0.62em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "✏️", l: "3%",  t: "82%", r: "12deg",  s: "0.7em" },
  { c: "🐭", l: "46%", t: "4%",  r: "-4deg",  s: "0.55em" },
  { c: "🐴", l: "7%",  t: "46%", r: "-4deg",  s: "0.62em" },
  { c: "💡", l: "88%", t: "40%", r: "8deg",   s: "0.58em" },
  { c: "❝",  l: "22%", t: "22%", r: "10deg",  s: "0.7em" },
...
const LEVELS_CFG = [
  {
    id: "fabula",
    label: "Mi fabulosa fábula",
    grad: "linear-gradient(180deg, #ffe97a, #d7b12a)",
    ink: "#3a2608",
    description: "Arma la fábula, descubre su moraleja y adivina sus personajes.",
    catLabel: "Mi fabulosa fábula",
  },
];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Crea y descubre fábulas paso a paso.
          </div>
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        {/* Derecha — grid 2x2 */}
        <div>
          <div className="ed-label" style={{ marginBottom: 10 }}>Elige tu guía de cuentos</div>
