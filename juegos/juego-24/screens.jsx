// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-24
// "De tantas formas se habla en Ecuador" (TEMA 3 del libro EDINUN, 14 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS (emparejar lengua y
// nacionalidad · clasificar el origen de las palabras · clasificar
// tecnicismos por materia). Tema: LENGUA Y CULTURA — el Ecuador
// plurilingüe, los préstamos y extranjerismos, el sociolecto y los
// tecnicismos/metalenguaje. Personaje destacado por defecto: Verne
// (explorador), guía del descubrimiento de las lenguas del Ecuador.
// Home sin chips de dificultad.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — símbolos de diálogo, lenguas y culturas del
// Ecuador (bocadillos, micrófono, mundo, plumas, selva) para
// ambientar sin distraer.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
...
const LEVELS_CFG = [
  {
    id: "voces",
    label: "De tantas formas se habla en Ecuador",
    grad: "linear-gradient(180deg, #5fe0d0, #2a8fb0)",
    ink: "#06303a",
    description: "Une cada lengua con su pueblo, descubre de dónde vienen las palabras y ubica los tecnicismos en su materia.",
    catLabel: "De tantas formas se habla en Ecuador",
  },
];
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 6 }}>
              De tantas formas se habla en Ecuador
            </div>
          ...
          <div style={{
            ...
            Descubre las lenguas, las palabras y los tecnicismos del Ecuador.
          </div>
...
// (explorador) porque guía el descubrimiento de las lenguas y
// culturas del Ecuador (tema intercultural, 13 años).
// ─────────────────────────────────────────────────────────────
