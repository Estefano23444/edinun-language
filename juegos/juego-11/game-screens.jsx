...
function RefranesGame({ app, setApp, go, onRestart }) {
  ...
  function handleVerify() {
    ...
    if (ronda === 0) {
      ...
      // Al fallar, dejar el tablero (con las sílabas correctas en verde)
      // visible más tiempo ANTES del "¡UPS!" para que el niño lo lea.
      setTimeout(() => answer(correct, formed, r1Pick.word, "🧪"), correct ? 380 : 2200);
    } else if (ronda === 1) {
      setR2Locked(true);
      let correct = true;
      ...
      // Al fallar, tablero visible más tiempo (con "→ grupo correcto") antes del "¡UPS!".
      setTimeout(() => answer(correct, userText, correctText, "🧴"), correct ? 380 : 2200);
    } else if (ronda === 2) {
      setR3Locked(true);
            ...
            <div key={g}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 5, width: "100%", alignItems: "center" }}>
                {inside.map((w) => {
                  ...
                  // Al fallar, revelamos a qué grupo pertenecía realmente.
