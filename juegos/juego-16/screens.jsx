// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para
// "Historias y misterios". Juego de 3 niveles por tema/edad:
//   • RELATOS (10 años) — el relato histórico.
//   • HERRAMIENTAS (10 años) — interjecciones, conectores y subjuntivo.
//   • DETECTIVES (13 años) — la narrativa policial y la inferencia.
// Home con selector de 3 temas. HUD del juego con pestañas de tema.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — temática "historia + misterio": pergaminos,
// relojes/clepsidras, lupas, llaves, plumas y signos de pregunta.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "🔍", l: "6%",  t: "12%", r: "-8deg", s: "0.6em" },
  { c: "📜", l: "82%", t: "16%", r: "6deg",  s: "0.6em" },
  { c: "⏳", l: "10%", t: "78%", r: "12deg", s: "0.55em" },
  { c: "🗝️", l: "88%", t: "72%", r: "-10deg", s: "0.55em" },
  { c: "🕵️", l: "45%", t: "8%",  r: "4deg",  s: "0.55em" },
  { c: "✒️", l: "3%",  t: "45%", r: "-4deg", s: "0.55em" },
  { c: "🏛️", l: "92%", t: "45%", r: "8deg",  s: "0.5em" },
...
const COSMIC_GLYPHS = [
  { c: "📜", l: "5%",  t: "10%", r: "-8deg", s: "0.78em" },
  { c: "🔍", l: "84%", t: "6%",  r: "6deg",  s: "0.7em" },
  { c: "⏳", l: "92%", t: "72%", r: "-12deg", s: "0.7em" },
  { c: "🕵️", l: "3%",  t: "82%", r: "12deg",  s: "0.78em" },
  { c: "🏛️", l: "46%", t: "4%",  r: "-4deg",  s: "0.6em" },
  { c: "🗝️", l: "7%",  t: "46%", r: "-4deg",  s: "0.62em" },
  { c: "✒️", l: "88%", t: "40%", r: "8deg",   s: "0.6em" },
  { c: "📚", l: "22%", t: "22%", r: "10deg",  s: "0.55em" },
  { c: "🧭", l: "70%", t: "24%", r: "-6deg",  s: "0.57em" },
  { c: "⚖️", l: "32%", t: "70%", r: "8deg",   s: "0.58em" },
  { c: "🪶", l: "62%", t: "78%", r: "-10deg", s: "0.6em" },
  { c: "?",  l: "18%", t: "58%", r: "14deg",  s: "0.48em" },
  { c: "📖", l: "78%", t: "56%", r: "-8deg",  s: "0.52em" },
  { c: "🎭", l: "50%", t: "88%", r: "4deg",   s: "0.52em" },
  { c: "★",  l: "40%", t: "38%", r: "-6deg",  s: "0.54em" },
];
...
// ─────────────────────────────────────────────────────────────
// Configuración de los 3 temas (un botón por tema/edad). El catLabel
// se inyecta como "currentCatLabel" para ResultsScreen. El char define
// el personaje guía por defecto de cada tema.
// ─────────────────────────────────────────────────────────────
const LEVELS_CFG = [
  {
    id: "relatos",
  ...
  },
  {
    id: "herramientas",
    age: "10 años",
    label: "Herramientas del escritor",
    grad: "linear-gradient(180deg, #ffe066, #e6bf24)",
    ink: "#3a2608",
    description: "Interjecciones, conectores lógicos y verbos en subjuntivo.",
    catLabel: "Herramientas del escritor · 10 años",
    char: "poeta",
  },
  {
    id: "detectives",
    age: "13 años",
    label: "Detectives de la palabra",
    grad: "linear-gradient(180deg, #5fb0ff, #2773d8)",
    ink: "#08264d",
    description: "La narrativa policial: pistas, sospechosos e inferencias del detective.",
    catLabel: "Detectives de la palabra · 13 años",
    char: "escritor",
  },
];

// ─────────────────────────────────────────────────────────────
// 1. HOME — saludo + selector de 3 temas + nombre + ENTRAR.
// ─────────────────────────────────────────────────────────────
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 540 }}>
          ...
          {/* Selector de tema por edad — 3 botones sólidos con degradado
              + cajita de descripción debajo. */}
          <div>
...
// ─────────────────────────────────────────────────────────────
// 2. SELECCIÓN DE PERSONAJE — idéntico al shell. El personaje por
// defecto depende del tema elegido (Gaby la poeta para los temas de
// 10 años; Rolli la escritora para el de detectives de 13 años).
// ─────────────────────────────────────────────────────────────
function CharacterScreen({ app, setApp, go }) {
  const lvCfg = LEVELS_CFG.find((l) => l.id === app.level) || LEVELS_CFG[0];
  const [sel, setSel] = useState(lvCfg.char || app.character || "poeta");
