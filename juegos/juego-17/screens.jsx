...
// "Escritores del mundo real" (TEMAS del libro EDINUN de Lengua).
// Juego de 2 niveles por edad (Home con selector, router por app.level):
//   • NIVEL 1 (11 años) — Escritura y tecnología (Verne).
//   • NIVEL 2 (12 años) — Textos periodísticos: la noticia (Rolli).
// Home con selector de tema (formato juego-14). HUD del juego con tabs.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — tema "escritura + tecnología + noticia":
// código, arrobas, hashtags, bits, cursor de texto, chat, titular.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "</>", l: "6%",  t: "12%", r: "-8deg", s: "0.5em" },
  { c: "@",   l: "82%", t: "16%", r: "6deg",  s: "0.62em" },
  { c: "#",   l: "10%", t: "78%", r: "12deg", s: "0.6em" },
  { c: "01",  l: "88%", t: "72%", r: "-10deg", s: "0.5em" },
  { c: "Aa",  l: "45%", t: "8%",  r: "4deg",  s: "0.5em" },
...
const COSMIC_GLYPHS = [
  { c: "</>", l: "5%",  t: "10%", r: "-8deg", s: "0.62em" },
  { c: "@",   l: "84%", t: "6%",  r: "6deg",  s: "0.78em" },
  { c: "#",   l: "92%", t: "72%", r: "-12deg", s: "0.74em" },
  { c: "{ }", l: "3%",  t: "82%", r: "12deg",  s: "0.7em" },
  { c: "Aa",  l: "46%", t: "4%",  r: "-4deg",  s: "0.59em" },
  { c: "01",  l: "7%",  t: "46%", r: "-4deg",  s: "0.67em" },
  { c: "→",   l: "88%", t: "40%", r: "8deg",   s: "0.65em" },
  { c: "✎",   l: "22%", t: "22%", r: "10deg",  s: "0.6em" },
  { c: "=",   l: "70%", t: "24%", r: "-6deg",  s: "0.57em" },
  { c: "💬",  l: "32%", t: "70%", r: "8deg",   s: "0.55em" },
  { c: "📰",  l: "62%", t: "78%", r: "-10deg", s: "0.55em" },
  { c: "?",   l: "18%", t: "58%", r: "14deg",  s: "0.48em" },
  { c: "⌨",   l: "78%", t: "56%", r: "-8deg",  s: "0.55em" },
  { c: "0",   l: "50%", t: "88%", r: "4deg",   s: "0.52em" },
...
// ─────────────────────────────────────────────────────────────
// Configuración de niveles (2 temas por edad). app.level enruta el
// juego. catLabel se inyecta como currentCatLabel para ResultsScreen.
// Personaje temático: escritura → Verne (explorador, el visionario);
// noticia → Rolli (escritor, el reportero). El niño puede cambiarlo.
// ─────────────────────────────────────────────────────────────
const LEVELS_CFG = [
  {
    id: "escritura",
    age: "11 años",
    label: "Escritura y tecnología",
    grad: "linear-gradient(180deg, #7ab8ff, #2773d8)",
    ink: "#08264d",
    description: "Línea del tiempo, atrapa lo digital y el asistente misterioso.",
    catLabel: "Escritura y tecnología · 11 años",
    char: "explorador",
  },
  {
    id: "noticia",
    ...
    ink: "#3a2608",
    description: "Arma la noticia, caza la opinión y detecta las trampas.",
    catLabel: "Textos periodísticos: la noticia · 12 años",
    char: "escritor",
  },
];

// ─────────────────────────────────────────────────────────────
// 1. HOME — saludo + selector de tema + nombre + ENTRAR.
// ─────────────────────────────────────────────────────────────
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 540 }}>
          ...
          {/* Selector de tema — botones sólidos con degradado + cajita
              de descripción debajo (formato juego-14). */}
          <div>
...
// personaje temático del nivel (Verne para escritura, Rolli para
// la noticia); el niño puede cambiarlo.
// ─────────────────────────────────────────────────────────────
function CharacterScreen({ app, setApp, go }) {
  const lvCfg = LEVELS_CFG.find((l) => l.id === app.level) || LEVELS_CFG[0];
  const [sel, setSel] = useState(lvCfg.char || app.character || "explorador");
