...
function EscrituraGame({ app, setApp, go, onRestart }) {
  ...
  function gradeR3(choice) {
    ...
    setTimeout(() => answer(correct, choice, r3Pick.answer, "🔎", "El asistente misterioso"), correct ? 450 : 1500);
  }
...
function NoticiaGame({ app, setApp, go, onRestart }) {
  ...
  function gradeR2(choice) {
    ...
    setTimeout(() => answer(correct, r2Pick.lines[choice], r2Pick.lines[r2Pick.opinionIdx], "🔍", "Caza la opinión"), correct ? 450 : 1500);
  }
  ...
  function gradeR3(choice) {
    ...
    setTimeout(() => answer(correct, choice, r3Pick.confiable ? "CONFIABLE" : "TRAMPA", "🛡️", "¿Confiable o trampa?"), correct ? 450 : 1500);
  }
