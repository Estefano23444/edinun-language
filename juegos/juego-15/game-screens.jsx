...
function MemoriasGame({ app, setApp, go, onRestart }) {
  ...
  const canVerify =
    ronda === 0 ? (r1Chosen !== null && r1Phase === "answering") :
  ...
  function handleVerify() {
    ...
    if (ronda === 0) {
      ...
      const ok = !!(step.options[r1Chosen] && step.options[r1Chosen].ok);
      // marca la casilla actual (verde/rojo) y avanza SIEMPRE al siguiente paso
      ...
      setR3Locked(true);
      const correct = r3Pick.options[r3Choice] && r3Pick.options[r3Choice].ok;
      const userText = r3Pick.options[r3Choice] ? r3Pick.options[r3Choice].t : "—";
      const okOpt = r3Pick.options.find((o) => o.ok);
      const correctText = okOpt ? okOpt.t : "—";
      setTimeout(() => answer(correct, userText, correctText, "🎭", "El tono justo"), 420);
    }
  }
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {ronda === 0 && (
        <CaminoCard
          ...
          chosen={r1Chosen}
          phase={r1Phase}
          onPick={(i) => { if (r1Phase === "answering") setR1Chosen((c) => (c === i ? null : i)); }}
        />
      )}
      ...
      {ronda === 2 && (
        <TonoCard
          ...
          chosen={r3Choice}
          locked={r3Locked}
          onPick={(i) => { if (!r3Locked) setR3Choice((c) => (c === i ? null : i)); }}
        />
      )}
