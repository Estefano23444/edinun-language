// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para JUEGO-22
// "Un diálogo para conocernos" (TEMA 3 del libro EDINUN, 13 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS (atrapar · simular un
// coloquio · clasificar causas). Tema: LENGUA Y CULTURA — el Ecuador
// plurilingüe, el coloquio vs. el debate y por qué desaparecen las lenguas.
// Personaje destacado por defecto: Verne (explorador), guía del descubrimiento
// de las lenguas del Ecuador. Home sin chips de dificultad.
...
const LEVELS_CFG = [
  {
    id: "dialogo",
    label: "Un diálogo para conocernos",
    grad: "linear-gradient(180deg, #5fe0d0, #2a8fb0)",
    ink: "#06303a",
    description: "Conoce las lenguas del Ecuador, modera un coloquio y descubre por qué se cuidan las lenguas.",
    catLabel: "Un diálogo para conocernos",
  },
];
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Descubre las lenguas del Ecuador y aprende a dialogar para conocernos.
          </div>
