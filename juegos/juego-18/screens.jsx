// screens.jsx — HomeScreen + CharacterScreen + CosmosBg para BAÚL-DE-ESCRITURA
// "El baúl de las herramientas de escritura" (TEMA 5 del libro EDINUN, 11 años).
// 1 nivel único, 3 rondas con mecánicas DISTINTAS (ruleta · laboratorio ·
// clasificar). Tema: las herramientas gramaticales de la escritura — el modo
// condicional, los prefijos y sufijos, y las desinencias. Home sin chips de
// dificultad.

const { useState, useEffect, useRef, useMemo } = React;

// ─────────────────────────────────────────────────────────────
// Glifos del fondo — las herramientas de escritura (🪶 ✒️ 📜 📖 ✏️) + las
// marcas del tema (si… · ía · re · des · -o) como texto, con signos de ritmo.
// ─────────────────────────────────────────────────────────────
const CHALK_GLYPHS = [
  { c: "si…", l: "6%",  t: "12%", r: "-8deg", s: "0.6em" },
  { c: "ía",  l: "82%", t: "16%", r: "6deg",  s: "0.62em" },
  { c: "re",  l: "10%", t: "78%", r: "12deg", s: "0.6em" },
  { c: "des", l: "86%", t: "72%", r: "-10deg", s: "0.5em" },
  { c: "-o",  l: "45%", t: "8%",  r: "4deg",  s: "0.5em" },
  { c: "🪶", l: "3%",  t: "45%", r: "-4deg", s: "0.6em" },
  { c: "✒️", l: "92%", t: "45%", r: "8deg",  s: "0.55em" },
...
const COSMIC_GLYPHS = [
  ...
  { c: "✏️", l: "3%",  t: "82%", r: "12deg",  s: "0.86em" },
  { c: "✒️", l: "46%", t: "4%",  r: "-4deg",  s: "0.59em" },
  { c: "📝", l: "7%",  t: "46%", r: "-4deg",  s: "0.62em" },
  { c: "🖋️", l: "88%", t: "40%", r: "8deg",   s: "0.6em" },
  { c: "ía", l: "22%", t: "22%", r: "10deg",  s: "0.52em" },
  { c: "re", l: "70%", t: "24%", r: "-6deg",  s: "0.55em" },
  { c: "des", l: "32%", t: "70%", r: "8deg",   s: "0.5em" },
  { c: "?",  l: "62%", t: "78%", r: "-10deg", s: "0.63em" },
  { c: "!",  l: "18%", t: "58%", r: "14deg",  s: "0.48em" },
  { c: "✓",  l: "78%", t: "56%", r: "-8deg",  s: "0.52em" },
  { c: "★",  l: "50%", t: "88%", r: "4deg",   s: "0.5em" },
  { c: "📚", l: "40%", t: "38%", r: "-6deg",  s: "0.56em" },
];
...
const LEVELS_CFG = [
  {
    id: "baul",
    label: "El baúl de las herramientas de escritura",
    grad: "linear-gradient(180deg, #ffe97a, #d7b12a)",
    ink: "#3a2608",
    description: "Abre el baúl y juega con las herramientas de la escritura.",
    catLabel: "El baúl de las herramientas de escritura",
  },
];
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 6 }}>
              El baúl de las herramientas de escritura
            </div>
          ...
          {/* Descripción del tema único — formato estándar del repo (caja
              centrada, igual que juego-11). Solo los temas, en dorado. La
              regla "la m antes de p y b" va en minúscula (son esas letras). */}
          <div style={{
            padding: "14px 16px",
            borderRadius: 14,
            background: "rgba(10,6,35,0.55)",
            ...
            color: "#ffd76e", letterSpacing: "0.04em",
            textAlign: "center",
          }}>
            El modo condicional · Prefijos y sufijos · Las desinencias
          </div>
...
// (escritor) porque el tema son las herramientas de escritura y él
// es el guía escritor del repo.
// ─────────────────────────────────────────────────────────────
